 ...
 * AndrewID: naveenl
 * Course: 17722 - Building user focused sensor systems
 */
package com.example.neofit;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    /**
     * This function is run when Start Button is clicked. The graph runs because of it.
     * @param view
     */
    void startCounting(View view) {
        start = true;
        sensorManager.registerListener(this, accelerometer, SensorManager.SENSOR_DELAY_GAME);
        if (oneGraph == true) {
            startGraph();
    ...
    /**
     * This the function which is used to stop and restart the activity. The graph also gets reset.
     * @param view
     */
